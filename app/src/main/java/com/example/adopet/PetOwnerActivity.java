    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CreateProfile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view){
                ...
                Intent intent = new Intent(PetOwnerActivity.this, CreateProfileActivity.class);
        ...
        GoProfile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view){
                ...
                Intent intent = new Intent(PetOwnerActivity.this, GotoMyProfileActivity.class);
                startActivity(intent);
        ...
        Toast.makeText(this, "Create a Pet Profile", Toast.LENGTH_SHORT).show();
    }
}